...
export default function TravelTimeline() {
  ...
  return (
    <section className="container py-10 sm:py-14">
      <h2 className="text-2xl sm:text-3xl font-bold font-headline text-center mb-2">Smart Planning Timeline</h2>
      <p className="mt-1 text-sm sm:text-base text-muted-foreground text-center">Agentic AI generates and updates your travel roadmap.</p>
