    ...
    <section className="container py-10 sm:py-14" id="profile">
      <div className="relative mb-8 overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-sky-500/10 via-violet-500/10 to-emerald-400/10">
        ...
        <div className="relative grid gap-4 p-5 sm:p-6">
          {user && (
            <p className="text-lg sm:text-xl md:text-2xl font-extrabold leading-snug tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-primary via-sky-500 to-accent drop-shadow">
          ...
          {user ? (
            ...
            <div className="flex items-center justify-between gap-3">
              ...
              {/* This should ideally trigger the sign-in modal, but linking to home for now */}
              <Link href="/" className="inline-flex items-center justify-center rounded-full border border-border px-3 py-1.5 text-sm font-medium hover:bg-white/10 transition">Sign in</Link>
            </div>
          )}
      ...
      <div className="grid gap-4">
        {trips.map((t) => (
          <Card key={t.id} className="group overflow-hidden border-white/15 bg-card/70 transition hover:border-accent/60 hover:shadow-lg">
            ...
            <CardContent className="p-4 pt-0 sm:p-5 sm:pt-0">
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2">
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-full px-3 py-1.5 text-xs font-medium border border-border hover:bg-secondary/60 transition"
                >
                ...
                <button
                  onClick={() => shareTrip(t)}
                  className="inline-flex items-center gap-2 rounded-full px-3 py-1.5 text-xs font-medium text-white bg-gradient-to-r from-primary to-accent hover:brightness-110 active:scale-95 transition"
                >
